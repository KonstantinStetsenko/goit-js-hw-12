import{a as b,S as C,i as u}from"./assets/vendor-DjDxajEQ.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))f(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&f(d)}).observe(document,{childList:!0,subtree:!0});function r(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function f(e){if(e.ep)return;e.ep=!0;const s=r(e);fetch(e.href,s)}})();let n=[],g=1,p=0,m=15;const S="35615577-2bf6ed1d70f9a1c328f0e4a49",w="https://pixabay.com/api/";async function y(i){n=[];try{const t=await b({url:w,params:{key:S,q:i,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:m,page:a}});n=t.data.hits,g=t.data.totalHits,p=g/m}catch(t){console.error("Error fetching data:",t)}}let F=new C(".gallery a",{captions:!0,captionsData:"alt",captionDelay:250});function L(i){if(i.length===0){console.log("Нет данных для отображения");return}const t=i.map(r=>`<li class="list-photo">
              ...
              </li>`).join("");o.userContainerUL.insertAdjacentHTML("beforeend",t),F.refresh()}let l="cat",a=1;const o={userContainerUL:document.querySelector(".users-list"),loader:document.querySelector(".loader"),form:document.querySelector(".form-serch"),btn:document.querySelector(".loadButton"),gallery:document.querySelector(".gallery"),input:document.querySelector(".input-serch")};function H(){o.loader.classList.add("loader")}function c(){o.loader.classList.remove("loader")}function v(){o.btn.classList.remove("buttonHiden")}function h(){o.btn.classList.add("buttonHiden")}document.addEventListener("DOMContentLoaded",()=>{c()});function q(){o.userContainerUL&&(o.userContainerUL.innerHTML="")}async function z(i){if(i.preventDefault(),q(),l=o.input.value,!l){h(),c(),u.warning({message:"Запрос пустой",backgroundColor:"#ffa500",messageSize:16,messageColor:"#FFF",iconColor:"",titleColor:"#fa0598e5",icon:"info-outline",titleSize:16,messageLineHeight:24,position:"topRight"}),console.log("Запрос пустой");return}H();try{await y(l),n.length===0?(h(),u.show({message:"Sorry, there are no images matching your search query. Please try again!",backgroundColor:"#ffa500",messageSize:16,messageColor:"#FFF",iconColor:"",titleColor:"#ffa500",icon:"info-outline",titleSize:16,messageLineHeight:24,position:"topRight"})):(L(n),n.length>=15&&v()),c()}catch(t){console.error("Ошибка при получении данных:",t),c()}o.input.value=""}o.form.addEventListener("submit",z);o.btn.addEventListener("click",async()=>{try{a+=1,a>p?(h(),u.warning({message:"We're sorry, but you've reached the end of search results.",backgroundColor:"#ffa500",messageSize:16,messageColor:"#FFF",iconColor:"",titleColor:"#fa0598e5",icon:"info-outline",titleSize:16,messageLineHeight:24,position:"topRight"}),console.log("Скрываем кнопку")):(v(),console.log("показываем кнопку")),await y(l,a),L(n),A(),console.log(a)}catch(i){console.log("Ошибка при загрузке следующей страницы:",i)}});function A(){const r=o.userContainerUL.lastElementChild.getBoundingClientRect().height*5;window.scrollBy({top:r,left:0,behavior:"smooth"})}
